              ...
              {recording ? (
                ...
                <div className="flex items-end gap-2">
                  ...
                  <textarea ref={textareaRef} value={newMessage}
                    ...
                    placeholder={pendingFile ? "Adicionar legenda (opcional)..." : isTecnico ? "Escrever no grupo técnico..." : "Escrever no grupo assistencial..."}
                    rows={1} className={`flex-1 px-4 py-2.5 rounded-2xl text-sm resize-none outline-none border transition max-h-32 ${
